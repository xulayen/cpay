...
exports.CpayLogsBLL = exports.CpayOrderBLL = exports.CayConfigBLL = void 0;
const DAL = require("../DAL/dbHelper");
class CayConfigBLL {
    constructor() {
    }
    static GetConfig(facid) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`GetConfig-${facid}`);
            let record = yield this.dal.select(this.tablename, [], " facid=:facid ", { facid: facid });
            console.log(record);
            return record;
        });
    }
}
exports.CayConfigBLL = CayConfigBLL;
CayConfigBLL.tablename = "t_cPay_config";
CayConfigBLL.dal = DAL.DbHelper.instance;
class BaseBLL {
...
class CpayOrderBLL extends BaseBLL {
    ...
    static IncreasedOrder(order, facid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res = yield this.dal.insert(this.tablename, columns, params_columns, params_data);
    ...
    static IncreasedOrderDetail(order, facid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let { columns, params_data } = this.BuildOrderParameters(params_columns, order, facid);
            res = yield this.dal.insert(this.tablename_order_detail, columns, params_columns, params_data);
            return res.affectedRows > 0;
        });
    }
    static UpdateOrder(out_trade_no, orderRes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let res_order = yield this.dal.update(this.tablename, columns, condition, params);
    ...
    static UpdateOrderDetail(out_trade_no, orderRes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            orderRes.out_trade_no = out_trade_no;
            params = this.BuildParameters(`${columns},${condition},`, orderRes);
            let res_order = yield this.dal.update(this.tablename_order_detail, columns, condition, params);
            return res_order.affectedRows > 0;
        });
    }
...
CpayOrderBLL.dal = DAL.DbHelper.instance;
...
CpayLogsBLL.dal = DAL.DbHelper.instance;
