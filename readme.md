...
| --------   | -----:   | :----: | :----: |
| [付款码支付](#付款码支付)        | ✔      |   微信开放平台不支持    |   ✔    |
| [扫码支付1](#扫码支付模式1)  [扫码支付2](#扫码支付模式2)         | ✔      |   微信开放平台不支持    |   ✖    |
| [H5支付](#h5支付)        | ✔    |   微信开放平台不支持    |   ✖    |
| [JSAPI支付](#jsapi支付)        | ✔      |   微信开放平台不支持    |   ✖    |
| [小程序支付](#小程序支付)        | ✔      |   微信开放平台不支持    |   ✖    |
| [APP支付](#app支付)        | ✔      |   微信开放平台不支持    |   ✖    |
| 刷脸支付        | ✖      |   微信开放平台不支持    |   ✖    |
| [支付结果通知](#微信支付结果通知)        | ✔      |   微信开放平台不支持    |   ✖    |
| [查询订单](#查询订单)       | ✔      |   微信开放平台不支持    |   ✖    |
| [撤销订单](#撤销订单)        | ✔      |   微信开放平台不支持    |   ✖    |
| [申请退款](#申请退款)        | ✔      |   微信开放平台不支持    |   ✖    |
| [查询退款](#查询退款)        | ✔      |   微信开放平台不支持    |   ✖    |
| [短链接生成](#短链接生成)        | ✔      |   微信开放平台不支持    |   ✖    |
| [网页授权](#公众号发起网页授权)        | ✔      |   ✔    |   ✖    |
| [JSSDK](#开放平台代替公众号使用jssdk)         |   ✖   |   ✔    |   ✖    |
| [红包](#微信现金红包)        |   ✔   |   微信开放平台不支持    |   ✖    |
| [零钱转账](#微信零钱转账)        |   ✔   |   微信开放平台不支持    |   ✖    |
